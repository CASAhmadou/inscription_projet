 ...
 */
final class Version20220615110344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne CHANGE adresse adresse VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne CHANGE adresse adresse VARCHAR(50) DEFAULT NULL');
